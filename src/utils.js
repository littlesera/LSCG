...
export function parseMsgWords(msg) {
    var lowerMsg = msg.toLowerCase();
    var lowerMsgWords = lowerMsg.match(/\b(\w+)\b/g);
    return lowerMsgWords;
}

export function OnChat(priority, description, callback) {
...
export function OnAction(priority, description, callback) {
    window.ChatRoomRegisterMessageHandler({ Priority: pri, Description: description, Callback: (data, sender, msg, metadata) => {
...
export function OnActivity(priority, description, callback) {
    window.ChatRoomRegisterMessageHandler({ Priority: pri, Description: description, Callback: (data, sender, msg, metadata) => {
...
export function SendAction(action, senderName = '') {
...
export function replace_template(text, source_name = '') {
    let result = text
