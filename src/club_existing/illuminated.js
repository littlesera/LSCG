...
// Export a marker to ensure this file is included by bundlers
// The actual illuminated library is available as window.illuminated after the IIFE above executes
export const __illuminated_loaded__ = true;