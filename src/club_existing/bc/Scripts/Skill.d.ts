 ...
 */
declare function SkillChange(SkillType: SkillType, SkillLevel: number, Progress: number, Push?: boolean): void;
/**
 ...
 * @param {boolean} [Push=true] - Pushes the skills to the server if TRUE
 */
declare function SkillSetRatio(SkillType: SkillType, Ratio: number, Push?: boolean): void;
/**
 * Gets the ratio % of effectiveness of a skill for the player
 * @param {SkillType} SkillType - Name of the skill to get the value of
 * @returns {number} - The current active ratio for the given skill
 */
declare function SkillGetRatio(SkillType: SkillType): number;
/**
 ...
 */
declare function SkillGetWithRatio(SkillType: SkillType): number;
/**
