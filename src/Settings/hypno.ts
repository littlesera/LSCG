...
export class GuiHypno extends GuiSubscreen {
    ...
    Run() {
		...
		// Enabled 					[true/false]
		DrawCheckbox(GuiSubscreen.START_X, 190 + 120, 64, 64, "Enabled", this.settings.enabled ?? true);
		...
		// Enabled 					[true/false]
		DrawCheckbox(GuiSubscreen.START_X, 190 + 480, 64, 64, "Enable Cycle", this.settings.enableCycle ?? true);
