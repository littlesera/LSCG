...
var LSCG = (function (exports) {
	...
	function IsIncapacitated(C) {
	    ...
	    if (C.LSCG && !!C.LSCG.StateModule) {
	        hypnotized = (_c = (_b = (_a = C.LSCG) === null || _a === void 0 ? void 0 : _a.StateModule.states.find(s => s.type == "hypnotized")) === null || _b === void 0 ? void 0 : _b.active) !== null && _c !== void 0 ? _c : false;
	        asleep = (_f = (_e = (_d = C.LSCG) === null || _d === void 0 ? void 0 : _d.StateModule.states.find(s => s.type == "asleep")) === null || _e === void 0 ? void 0 : _e.active) !== null && _f !== void 0 ? _f : false;
	    }
	    else if (C.LSCG && !!C.LSCG.HypnoModule) { // LEGACY HANDLING
	        hypnotized = ((_g = C.LSCG.HypnoModule.hypnotized) !== null && _g !== void 0 ? _g : false) || ((_h = C.LSCG.InjectorModule.brainwashed) !== null && _h !== void 0 ? _h : false);
	        asleep = (_j = C.LSCG.InjectorModule.asleep) !== null && _j !== void 0 ? _j : false;
	    }
	        ...
	        return [
	            {
	                ...
	                setting: () => { var _a; return (_a = Player.LSCG.StateModule.immersive) !== null && _a !== void 0 ? _a : false; },
	...
	class HypnoModule extends BaseModule {
	    ...
	    get hypnoActivated() {
	        var _a, _b, _c;
	        return (_c = (_b = (_a = this.StateModule) === null || _a === void 0 ? void 0 : _a.HypnoState) === null || _b === void 0 ? void 0 : _b.config.active) !== null && _c !== void 0 ? _c : false;
	...
	class MiscModule extends BaseModule {
	    ...
	    get sleepState() {
	        var _a;
	        return (_a = getModule("StateModule")) === null || _a === void 0 ? void 0 : _a.SleepState;
	    }
	    // Disabled as it's managed via General
	    // get settingsScreen(): Subscreen | null {
	    //     return GuiMisc;
	    ...
	    Passout() {
	        ...
	        this.settings.chloroformedAt = CommonTime();
	        clearTimeout(this.passoutTimer);
	        (_a = getModule("StateModule")) === null || _a === void 0 ? void 0 : _a.SleepState.Activate(undefined, true);
	    }
	    ChloroformWearOff() {
	...
	class InjectorModule extends BaseModule {
	    ...
	    get asleep() { return this.stateModule.SleepState.Active; }
	    ;
	    //set asleep(val: boolean) { if (this.settings.asleep != val){ this.settings.asleep = val; settingsSave(true);}}
	    get brainwashed() { return this.stateModule.HypnoState.Active; }
	    ;
	...
	class StateMigrator extends BaseMigrator {
	    ...
	    Migrate(fromVersion) {
	        ...
	        if (!!Player.LSCG.HypnoModule.existingEye1Color) {
	            ...
	            hypnoState.extensions["existingEye1Color"] = Player.LSCG.HypnoModule.existingEye1Color;
	            hypnoState.extensions["existingEye1Name"] = Player.LSCG.HypnoModule.existingEye1Name;
	            hypnoState.extensions["existingEye2Color"] = Player.LSCG.HypnoModule.existingEye2Color;
	            hypnoState.extensions["existingEye2Name"] = Player.LSCG.HypnoModule.existingEye2Name;
	            hypnoState.extensions["existingEyeExpression"] = Player.LSCG.HypnoModule.existingEyeExpression;
	        }
...
${LSCG_CHANGES}`;
	...
	class CommandModule extends BaseModule {
	    ...
	    get states() { return getModule("StateModule"); }
	...
	class BaseState {
	    get StateModule() {
	        if (!this._state)
	            this._state = getModule("StateModule");
	        return this._state;
	    }
	    get config() {
	    ...
	    Activate(memberNumber, emote) {
	        ...
	        this.config.activatedBy = memberNumber !== null && memberNumber !== void 0 ? memberNumber : -1;
	...
	class HypnoState extends BaseState {
	    ...
	    constructor(stateModule) {
	        ...
	        this._hornyCheck = 0;
	        this._hornyInterval = 30000; // 30s horny ticks
	        // Emote Strings
	        this.hypnoBlockStrings = [
	            "%NAME%'s eyelids flutter as a thought tries to enter %POSSESSIVE% blank mind...",
	            "%NAME% sways weakly in %POSSESSIVE% place, drifting peacefully...",
	    ...
	    Init() {
	        hookFunction("Player.HasTints", 4, (args, next) => {
	            var _a;
	            if (!this.StateModule.Enabled || !((_a = Player.ImmersionSettings) === null || _a === void 0 ? void 0 : _a.AllowTints))
	                return next(args);
	            if (this.Active)
	                return true;
	            return next(args);
	        ...
	        hookFunction("Player.GetBlurLevel", 4, (args, next) => {
	            var _a;
	            if (!this.StateModule.Enabled || !((_a = Player.GraphicsSettings) === null || _a === void 0 ? void 0 : _a.AllowBlur))
	                return next(args);
	            if (this.Active)
	                return 3;
	            return next(args);
	    ...
	    EnforceEyes() {
	        var _a, _b, _c, _d, _e;
	        let hypnoSettings = (_a = getModule("HypnoModule")) === null || _a === void 0 ? void 0 : _a.settings;
	        var eyeAsset1 = AssetGet("Female3DCG", "Eyes", (_b = "Eyes" + hypnoSettings.hypnoEyeType) !== null && _b !== void 0 ? _b : 9);
	        var eyeAsset2 = AssetGet("Female3DCG", "Eyes2", (_c = "Eyes" + hypnoSettings.hypnoEyeType) !== null && _c !== void 0 ? _c : 9);
	        ...
	        if (!!eyes1) {
	            ...
	            eyes1.Color = (_d = hypnoSettings.hypnoEyeColor) !== null && _d !== void 0 ? _d : "#A2A2A2";
	        }
	        if (!!eyes2) {
	            eyes2.Asset = eyeAsset2 !== null && eyeAsset2 !== void 0 ? eyeAsset2 : {};
	            eyes2.Color = (_e = hypnoSettings.hypnoEyeColor) !== null && _e !== void 0 ? _e : "#A2A2A2";
	        }
	        ChatRoomCharacterUpdate(Player);
	    }
	    ResetEyes() {
	        var _a, _b, _c;
	        var eyeAsset1 = AssetGet("Female3DCG", "Eyes", (_a = this.extensions["existingEye1Name"]) !== null && _a !== void 0 ? _a : "Eyes5");
	        var eyeAsset2 = AssetGet("Female3DCG", "Eyes2", (_b = this.extensions["existingEye2Name"]) !== null && _b !== void 0 ? _b : "Eyes5");
	        var eyes1 = InventoryGet(Player, "Eyes");
	        var eyes2 = InventoryGet(Player, "Eyes2");
	        if (!!eyes1) {
	            eyes1.Asset = eyeAsset1 !== null && eyeAsset1 !== void 0 ? eyeAsset1 : {};
	        ...
	        CharacterSetFacialExpression(Player, "Eyes", (_c = this.extensions["existingEyeExpression"]) !== null && _c !== void 0 ? _c : null);
	        ChatRoomCharacterUpdate(Player);
	...
	class StateModule extends BaseModule {
	    ...
	    constructor() {
	        super();
	        this._tickCheck = 0;
	        this._tickInterval = 1000; // ever second
