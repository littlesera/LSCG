...
if (window.CCollar_Version) {
	if (is_newer(window.CCollar_Version, CCollar_Version)) {
		beepNewVersion();
		console.log('Choke Collar has been udapted')
	}
	throw new LoadedError('Choke Collar already loaded')
}
// SDK stuff
